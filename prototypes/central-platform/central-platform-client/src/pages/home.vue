...
<template>
    ...
    <div class="h-screen w-full flex overflow-hidden select-none">
        <main
            class="my-1 pt-2 pb-2 px-10 flex-1 bg-neutral-900 rounded-l-lg
            ...
            <div class="flex">
                ...
                <div
                    ...
                    bg-neutral-800 rounded-lg text-white border-2 border-transparent hover:border-emerald-500 transition duration-500">
                    ...
                    <div class="flex flex-col items-center pb-10">
                        <img
                            ...
                            alt=" empty schedule" />
                        <button class=" bg-emerald-500 border-2 border-transparent hover:border-emerald-200 hover:bg-emerald-400 duration-500 transition rounded-lg py-2 px-4">
                            View Dashboard
                        </button>
        ...
        <aside
            class="w-1/4 my-1 mr-1 px-6 py-4 flex flex-col  bg-neutral-900
            text-emerald-400 rounded-r-lg overflow-y-auto">
            <!-- Right side NavBar -->
            ...
            <button
                class="mt-8 flex border-2 border-transparent items-center py-4 px-3 text-white rounded-lg
                bg-emerald-500 shadow focus:outline-none hover:bg-emerald-400 hover:border-emerald-300 transition duration-500">
                <!-- Action -->
